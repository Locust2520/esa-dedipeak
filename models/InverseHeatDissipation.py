...
class Model(nn.Module):
    ...
    def q_xt_x0(self, batch_y, batch_y_mark, batch_x, batch_x_mark, t):
        x_t = self.blur(batch_y, t) + self.training_noise * torch.randn_like(batch_y, device=batch_y.device)
    ...
    def p_xt(self, xt: torch.Tensor, eps_hat: torch.Tensor, t: torch.Tensor) -> torch.Tensor:
        ...
        xt = xt + eps_hat
        xt = xt + noise * self.blur_sigmas[t][:, None, None] * self.sampling_noise
        return xt
